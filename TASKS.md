...
## 進捗サマリ
- 全 26 件 / 完了 20 件 / 進行中 4 件 / 未着手 2 件
- 現在のタスク: T-015（第 2 段階 + Round 2）/ T-021（Round 2）/ T-023 / T-024（実装中）
- 最終更新: 2026-09-03T12:55:00+09:00
...
| T-023 | ボード表示（列・カード・仮想スクロール） | T-021 | in_progress | 1 | - |
| T-024 | リスト表示（テーブル・並べ替え・仮想スクロール） | T-021 | in_progress | 1 | - |
